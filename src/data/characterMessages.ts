...
// ─── 날씨 조건별 공통 문구 (나중에 날씨 API 연동시 사용) ──────
export const WEATHER_MESSAGES: CharacterMessage[] = [
  { text: "비 오는 날도 걷는 사람, 진짜 멋있어요 ☔", type: "weather", weatherCondition: "rainy" },
  { text: "빗소리 들으며 걷기, 꽤 감성적이잖아요 🌧️", type: "weather", weatherCondition: "rainy" },
  { text: "맑은 날씨네요! 걷기 딱 좋아요 ☀️", type: "weather", weatherCondition: "sunny" },
  { text: "햇살 좋은 날, 밖에 나가봐요 🌤️", type: "weather", weatherCondition: "sunny" },
  { text: "흐린 날엔 걷기가 오히려 편해요 🌥️", type: "weather", weatherCondition: "cloudy" },
  { text: "눈 오는 날 산책, 평생 기억에 남아요 ❄️", type: "weather", weatherCondition: "snow" },
  { text: "더운 날엔 아침 일찍이 최고예요 🌅", type: "weather", weatherCondition: "hot" },
  { text: "쌀쌀한 날 걷고 나면 얼굴이 빨개져요 🥶", type: "weather", weatherCondition: "cold" },
];
...
export const CHARACTER_MESSAGES: Record<string, CharacterMessage[]> = {
  ...
  { text: "유튜브 알고리즘보다 내 다리 알고리즘을 믿어봐요 🎬", type: "lazy" },
  ],
  ...
  runner: [
    ...
    { text: "달리기 전엔 다들 귀찮아요. 달리고 나면 다들 뿌듯해요 😤", type: "greeting" },
    // 응원
  ...
  hiker: [
    ...
    { text: "오늘 오른 계단 수, 엘리베이터 탄 사람과 비교불가 🏆", type: "cheer" },
    // 재치
    { text: "등산 간다고 했을 때 다들 말렸죠? 역시 혼자가 편해 ㅋ", type: "witty" },
  ...
  power_walker: [
    ...
    { text: "걷는 건데 왜 이렇게 뿌듯하지? 그게 파워워킹 😤", type: "greeting" },
    // 응원
    ...
    // 재치
    { text: "파워워킹은 달리기보다 멋있어요. 여유 있어 보이잖아요 😎", type: "witty" },
    { text: "빠르게 걷다 보면 앞사람 추월하고 싶어짐 ㅋ", type: "witty" },
    { text: "이어폰에서 신나는 노래 나오면 나도 모르게 속도 업 🎵", type: "witty" },
...
export function getRandomMessage(
  ...
  const messages = CHARACTER_MESSAGES[characterId] ?? CHARACTER_MESSAGES["walker"];
