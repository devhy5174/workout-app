            ...
            <div className="flex items-center gap-2">
              <button
                ...
                onClick={() =>
                  setPendingInquiry({
                    label: "카카오톡 채널",
                    url: "http://pf.kakao.com/_EnhbX/chat",
                  })
                }
              ...
              <button
                ...
                onClick={() =>
                  setPendingInquiry({
                    label: "이메일",
                    url: "mailto:devhy5174@gmail.com",
                  })
                }
        ...
        <TextSheet title="개인정보 처리방침" onClose={() => setSheet(null)}>
          <div className="flex flex-col gap-5 text-gray-600">
            ...
            <div>
              ...
              <p className="text-xs leading-relaxed mb-2">
                서비스는 원활한 운영을 위해 아래 업체에 개인정보 처리를
                위탁합니다.
              </p>
              <div className="bg-gray-50 rounded-xl p-3 flex flex-col gap-2">
                {[
                  {
                    company: "Supabase Inc. (미국)",
                    task: "데이터베이스·인증·실시간 동기화 서버 운영",
                  },
                  {
                    company: "Kakao Corp. (한국)",
                    task: "카카오 소셜 로그인 인증",
                  },
                  {
                    company: "Google LLC (미국)",
                    task: "구글 소셜 로그인 인증",
                  },
                ].map(({ company, task }) => (
                  <div key={company}>
            ...
            <div>
              ...
              <ul className="text-xs leading-relaxed list-disc list-inside space-y-1">
                <li>개인정보 열람 요청</li>
                <li>
                  오류 정정 요청 (닉네임·신체 정보 등 앱 내에서 직접 수정 가능)
                </li>
          ...
          <div className="flex flex-col gap-5 text-gray-600">
            ...
            <div>
              ...
              <div className="bg-gray-50 rounded-xl p-3 text-xs space-y-1">
                ...
                <p>
                  <span className="font-semibold text-gray-700">카카오톡:</span>{" "}
                  설정 &gt; 문의하기
                </p>
              </div>
            </div>
