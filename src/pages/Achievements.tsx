...
const DIFFICULTY_BADGE: Record<
  ...
  { bg: string; ring: string; label: string; labelColor: string }
> = {
  easy:   { bg: "from-emerald-400 to-green-500",   ring: "ring-emerald-300", label: "쉬움",   labelColor: "text-emerald-600 bg-emerald-50" },
  normal: { bg: "from-blue-400 to-indigo-500",      ring: "ring-blue-300",    label: "보통",   labelColor: "text-blue-600 bg-blue-50" },
  hard:   { bg: "from-orange-400 to-red-500",       ring: "ring-orange-300",  label: "어려움", labelColor: "text-orange-600 bg-orange-50" },
  legend: { bg: "from-violet-500 to-fuchsia-500",   ring: "ring-violet-400",  label: "레전드", labelColor: "text-violet-600 bg-violet-50" },
};
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center gap-3 mb-5">
          <div
            className={`relative w-24 h-24 rounded-full flex items-center justify-center text-5xl shadow-lg ${
              isUnlocked
                ? `bg-gradient-to-br ${diff.bg} ring-4 ring-yellow-300 ring-offset-2`
                : "bg-gray-200 grayscale ring-4 ring-gray-200 ring-offset-2"
            }`}
          >
...
function BadgeCard({
  ...
  return (
    ...
    >
      ...
      {/* 이름 */}
      <p
        className={`text-xs font-extrabold text-center leading-tight ${
