...
| table_name       | columns                                                                                                                                                                                                                                                                                                                                                                               |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| active_sessions  | id (uuid), user_id (uuid), exercise_type (text), started_at (timestamptz), last_seen (timestamptz), is_active (boolean), active_bubble (text)                                                                                                                                                                                                                                         |
| app_users        | id (uuid), email (text), nickname (text), gender (text), age (integer), character_id (text), theme (text), language (text), points (integer), streak (integer), height (numeric), weight (numeric), bmi (numeric), created_at (timestamptz), activity_type_id (integer), title (text), is_admin (boolean), nickname_changed_at (timestamptz), is_premium (boolean), premium_expires_at (timestamptz) |
| community_cheers | post_id (uuid), user_id (uuid), created_at (timestamptz)                                                                                                                                                                                                                                                                                                                              |
| community_posts  | id (uuid), user_id (uuid), text (text), tags (ARRAY), steps (integer), cheers (integer), created_at (timestamptz), frame_id (text), source_type (text), source_id (text), source_date (date)                                                                                                                                                                                          |
| event_grants     | id (uuid), event_id (uuid), user_id (uuid), reward_type (text), bubble_id (text), title_text (text), granted_at (timestamptz), granted_by (uuid)                                                                                                                                                                                                                                      |
| events           | id (uuid), title (text), description (text), start_date (date), end_date (date), category (text), condition_type (text), condition_value (integer), reward_type (text), bubble_id (text), title_text (text), is_active (boolean), created_at (timestamptz), is_fixed (boolean)                                                                                                        |
| fcm_tokens       | id (uuid), user_id (uuid), token (text), created_at (timestamptz)                                                                                                                                                                                                                                                                                                                     |
| notifications    | id (uuid), user_id (uuid), type (text), title (text), body (text), data (jsonb), is_read (boolean), created_at (timestamptz)                                                                                                                                                                                                                                                          |
| parties          | id (uuid), created_by (uuid), name (text), description (text), tags (ARRAY), target_steps (integer), exercise_time (text), max_members (integer), is_active (boolean), created_at (timestamptz), start_date (date), end_date (date), goal_type (text), target_distance (numeric)                                                                                                      |
| party_cheers     | id (uuid), party_id (uuid), user_id (uuid), nickname (text), message (text), created_at (timestamptz)                                                                                                                                                                                                                                                                                 |
| party_members    | id (uuid), party_id (uuid), user_id (uuid), joined_at (timestamptz)                                                                                                                                                                                                                                                                                                                   |
| party_notices    | id (uuid), party_id (uuid), user_id (uuid), message (text), created_at (timestamptz)                                                                                                                                                                                                                                                                                                  |
| point_history    | id (uuid), user_id (uuid), points (integer), description (text), icon (text), type (text), created_at (timestamptz)                                                                                                                                                                                                                                                                   |
...
| user_goals       | id (uuid), user_id (uuid), goal_type (text), goal_value (numeric), is_active (boolean), created_at (timestamptz)                                                                                                                                                                                                                                                                      |
| workout_history  | id (uuid), user_id (uuid), date (date), duration (integer), distance (numeric), steps (integer), calories (integer), points_earned (integer), workout_type (text), goal_achieved (boolean), created_at (timestamptz)                                                                                                                                                                  |
